        ...
        <section id="Lista" className={estilos.body}>
            ...
            <main className={estilos.main}>
                <section className={estilos.section}>
                    ...
                    <section className="bg-[#0000009a] fixed w-[43%] h-[91%] mt-2 ml-[49%] -z-10"></section>
                </section>
                <section id="detalles" className="col-span-4 bg-[#0000009a] w-[40vw] fixed left-[55.5vw]">
                    <AreaDetalles clases={estilos.detalles} species={pokeEspecie} idcss={poketipo} id={pokeid} name={pokename} types={poketipo} />
                </section>
            </main>
